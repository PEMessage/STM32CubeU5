...
source ../../env.sh
secbootadd0=0x1800C0 # 24K
    # FLASH_HASH_REF 0x0 (8K)
    # BL2_NVCNT (8K) // HUK and anti roll back counter
    # FLASH_AREA_PERSO (8K) // 自定义数据
flashsectnbr=0x7F
...
# some other manually configure, optionbyte
# // SEC WM
# [INF] BANK 1 secure flash [0, 15] (First 128KB is secure): OB [0, 127] 
# // 前128K 为 Secure
# 	// FLASH_HASH_REF 8K [HDP]
# 	// BL2_NVCNT  8K [HDP]
# 	// FLASH_AREA_PERSO  8K [ W Protect ] [HDP]
# 	// BL2 72K [ W Protect ] [HDP]
# 	// BL2 NOHDP 8K [W Protect]
# 	// Area
# 		// S_PARTITION 24K
# 		// ...
#
